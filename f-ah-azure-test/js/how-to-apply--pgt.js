...
/******/ 	deferredModules.push([6,"react","vendor-dependencies","axios","vendor-direct"]);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _buttons_apply__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./buttons/apply */ "./src/patterns/how-to-apply/buttons/apply.js");
...
function HowToApply(props) {
  ...
  const [modalVisible, setModalVisible] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
        [firstStep, setFirstStep] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
        // Controls 'Start again' visibility
  [progressQualification, setProgressQualification] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
        [progressRoute, setProgressRoute] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
        [progressDate, setProgressDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
        [progressMethod, setProgressMethod] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
        [furtherStepsPendingIndicator, setFurtherStepsPendingIndicator] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
        [windowPrompt, setWindowPrompt] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])('Choose the qualification you wish to apply for:'),
        ...
        furtherStepsPending = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
  ...
  let [selectionButtonQualification, setSelectionButtonQualification] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionLinkQualification, setSelectionLinkQualification] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionButtonRoute, setSelectionButtonRoute] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionLinkRoute, setSelectionLinkRoute] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionButtonDate, setSelectionButtonDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionLinkDate, setSelectionLinkDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionHeadingLocationOne, setSelectionHeadingLocationOne] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionButtonLocationOneDate, setSelectionButtonLocationOneDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      [selectionLinkLocationOneDate, setSelectionLinkLocationOneDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      [selectionHeadingLocationTwo, setSelectionHeadingLocationTwo] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
      [selectionButtonLocationTwoDate, setSelectionButtonLocationTwoDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      [selectionLinkLocationTwoDate, setSelectionLinkLocationTwoDate] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(false),
      [selectionLinkMethod, setSelectionLinkMethod] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(),
  ...
  function filterMethodsData(methods, dateSpecificPrompt) {
    ...
    selectedQualificationData ? qualNav = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    ...
    selectedRouteData ? routeNav = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      className: "how-to-apply--pgt--js__modal__progress__previous"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      className: "how-to-apply--pgt--js__modal__progress__wrapper",
      onClick: () => {
    ...
    selectedDateData ? dateNav = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      className: "how-to-apply--pgt--js__modal__progress__previous"
    }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
      className: "how-to-apply--pgt--js__modal__progress__wrapper",
      onClick: () => {
    ...
    methodNav = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    ...
    methods.map(m => {
      ...
      linkOptions = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_buttons_apply__WEBPACK_IMPORTED_MODULE_1__["default"], {
        data: methodLinks
      });
  ...
  function filterLocation(data, location, heading) {
    ...
    let headingVal = locations.map(l => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", {
      key: l
    }, l)); // Create buttons
    ...
    let buttonVal = uniqueLocationDataArray.map(fd => {
      if (fd['options'].length > 0) {
        if (fd['options'][0]['options'].length > 1) {
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
            key: fd
          }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
          ...
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_buttons_apply__WEBPACK_IMPORTED_MODULE_1__["default"], {
  ...
  function filterDatesData(data) {
    ...
    if (selectedDateData) {
      dateNav = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        className: "how-to-apply--pgt--js__modal__progress__current"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "how-to-apply--pgt--js__modal__progress__wrapper"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
      ...
      locations.map(l => {
        ...
        methods.map(() => {
          ...
          if (data.length > 1 || data[0]['options'].length > 1) {
            ...
            selectedDateValue = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
              className: "how-to-apply--pgt--js__modal__progress__current"
            }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
              className: "how-to-apply--pgt--js__modal__progress__wrapper"
            }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        ...
        locations.map(l => {
          ...
          methods.map(() => {
            ...
            if (data.length > 1) {
              ...
              selectedRouteValue = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
                className: "how-to-apply--pgt--js__modal__progress__current"
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
                className: "how-to-apply--pgt--js__modal__progress__wrapper"
              }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
  ...
  function filterQualificationData(data) {
    ...
    if (data.length > 1) {
      ...
      selectedQualificationValue = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
        className: "how-to-apply--pgt--js__modal__progress__current"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
        className: "how-to-apply--pgt--js__modal__progress__wrapper"
      }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", {
  ...
  const question = 'qualification',
        qualificationQuestion = question === 'qualification' && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "how-to-apply--pgt--js__modal__content-wrapper"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, windowPrompt), !(selectionHeadingLocationOne || selectionButtonLocationOneDate || selectionLinkLocationOneDate || selectionHeadingLocationTwo || selectionButtonLocationTwoDate || selectionLinkLocationTwoDate) ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    className: "how-to-apply--pgt--js__options"
  }, selectionButtonQualification, selectionLinkQualification, selectionButtonRoute, selectionLinkRoute, selectionButtonDate, selectionLinkDate, selectionLinkMethod) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, selectionHeadingLocationOne, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    className: "how-to-apply--pgt--js__options how-to-apply--pgt--js__options--multiple-locations"
  }, selectionButtonLocationOneDate, selectionLinkLocationOneDate), selectionHeadingLocationTwo, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    className: "how-to-apply--pgt--js__options how-to-apply--pgt--js__options--multiple-locations"
  }, selectionButtonLocationTwoDate, selectionLinkLocationTwoDate)))),
        alternative = props.element.dataset.otheryear && props.element.dataset.otherurl && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(() => {
    if (!focusTrap.activate) {
      setFocusTrap(focus_trap__WEBPACK_IMPORTED_MODULE_3___default()(getModalContent(), {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
    ...
    "aria-label": "Close"
  })), !firstStep ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
  ...
  }), ' ', /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("span", null, "Start again"))) : null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ol", {
    className: "how-to-apply--pgt--js__modal__progress"
  }, progressQualification, progressRoute, progressDate, progressMethod, furtherStepsPendingIndicator), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "how-to-apply--pgt--js__modal__content-wrapper"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Start in ", props.element.dataset.year)), qualificationQuestion, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    className: "how-to-apply--pgt--js__modal__content-wrapper"
  }, alternative))));
}

HowToApply.propTypes = {
  config: prop_types__WEBPACK_IMPORTED_MODULE_2___default.a.array,
...
module.exports = __webpack_require__(/*! /home/rof/src/github.com/CityUniversityLondon/polaris-staging/src/how-to-apply--pgt.js */"./src/how-to-apply--pgt.js");
